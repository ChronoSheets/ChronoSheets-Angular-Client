 ...
 */
import { CSTimesheet } from './cSCSTimesheet';


export interface CSApiResponseListTimesheet {
    data?: Array<CSTimesheet>;
    status?: CSApiResponseListTimesheet.CSStatusEnum;
    message?: string;
}
export namespace CSApiResponseListTimesheet {
