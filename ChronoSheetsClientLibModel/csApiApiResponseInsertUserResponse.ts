 ...
 */
import { CsApiInsertUserResponse } from './csApiCsApiInsertUserResponse';


export interface CsApiApiResponseInsertUserResponse {
     ...
     */
    status?: CsApiApiResponseInsertUserResponse.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseInsertUserResponse {
