 ...
 */
import { CSFleetSummaryReportItem } from './cSCSFleetSummaryReportItem';


export interface CSApiResponseListFleetSummaryReportItem { 
    data?: Array<CSFleetSummaryReportItem>;
    status?: CSApiResponseListFleetSummaryReportItem.CSStatusEnum;
    message?: string;
}
export namespace CSApiResponseListFleetSummaryReportItem {
