 ...
 */
export interface CSApiResponseListJobSeriesReportItem { 
    /**
     * The main Data of the response
     */
    data?: Array<CSJobSeriesReportItem>;
    /**
     * The API response status. Indicates if the request was successful, failed or was unauthorised.
     */
    status?: CSApiResponseListJobSeriesReportItem.CSStatusEnum;
    /**
...
export namespace CSApiResponseListJobSeriesReportItem {
