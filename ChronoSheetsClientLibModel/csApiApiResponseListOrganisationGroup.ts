 ...
 */
import { CsApiOrganisationGroup } from './csApiCsApiOrganisationGroup';


export interface CsApiApiResponseListOrganisationGroup {
    data?: Array<CsApiOrganisationGroup>;
    status?: CsApiApiResponseListOrganisationGroup.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseListOrganisationGroup {
