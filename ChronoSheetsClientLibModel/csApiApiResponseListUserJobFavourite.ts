 ...
 */
import { CsApiUserJobFavourite } from './csApiCsApiUserJobFavourite';


export interface CsApiApiResponseListUserJobFavourite {
    data?: Array<CsApiUserJobFavourite>;
    /**
     * 0 = Succeeded, 1 = FatalException, 2 = GeneralError, 3 = ValidationError, 4 = UnAuthorized, 5 = SessionExpired, 128 = TestingABC
     */
    status?: CsApiApiResponseListUserJobFavourite.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseListUserJobFavourite {
