 ...
 */
import { CSCombinedReportsData } from './cSCSCombinedReportsData';


export interface CSApiResponseCombinedReportsData {
    data?: CSCombinedReportsData;
    status?: CSApiResponseCombinedReportsData.CSStatusEnum;
    message?: string;
}
export namespace CSApiResponseCombinedReportsData {
