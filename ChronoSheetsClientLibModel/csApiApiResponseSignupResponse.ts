 ...
 */
import { CsApiSignupResponse } from './csApiCsApiSignupResponse';


export interface CsApiApiResponseSignupResponse {
    data?: CsApiSignupResponse;
    status?: CsApiApiResponseSignupResponse.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseSignupResponse {
