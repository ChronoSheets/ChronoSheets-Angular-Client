 ...
 */
import { CSDoLoginResponse } from './cSCSDoLoginResponse';


export interface CSApiResponseDoLoginResponse {
    data?: CSDoLoginResponse;
    status?: CSApiResponseDoLoginResponse.CSStatusEnum;
    message?: string;
}
export namespace CSApiResponseDoLoginResponse {
