...
export interface CSApiResponseListTimesheetTask { 
    data?: Array<CSTimesheetTask>;
    status?: CSApiResponseListTimesheetTask.CSStatusEnum;
    message?: string;
}
export namespace CSApiResponseListTimesheetTask {
