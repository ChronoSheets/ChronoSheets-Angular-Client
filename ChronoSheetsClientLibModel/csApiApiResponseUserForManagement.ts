...
export interface CsApiApiResponseUserForManagement {
    data?: CsApiUserForManagement;
    status?: CsApiApiResponseUserForManagement.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseUserForManagement {
