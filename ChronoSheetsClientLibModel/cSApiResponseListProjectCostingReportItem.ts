 ...
 */
import { CSProjectCostingReportItem } from './cSCSProjectCostingReportItem';


/**
 * A standard API response
 */
export interface CSApiResponseListProjectCostingReportItem { 
    /**
     * The main Data of the response
     */
    data?: Array<CSProjectCostingReportItem>;
    /**
     * The API response status. Indicates if the request was successful, failed or was unauthorised.
     */
    status?: CSApiResponseListProjectCostingReportItem.CSStatusEnum;
    /**
...
export namespace CSApiResponseListProjectCostingReportItem {
