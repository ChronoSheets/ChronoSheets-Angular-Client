...
export interface CSExtendedGeofence { 
    jobCode?: string;
    taskName?: string;
    createdBy?: string;
    updatedBy?: string;
    ...
    triggerSettings?: CSExtendedGeofence.CSTriggerSettingsEnum;
    alertToOrgGroupId?: number;
    alertSettings?: CSExtendedGeofence.CSAlertSettingsEnum;
    startTimeHour?: number;
    startTimeMinute?: number;
    endTimeHour?: number;
    endTimeMinute?: number;
}
export namespace CSExtendedGeofence {
