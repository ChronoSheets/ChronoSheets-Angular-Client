...
export interface CsApiApiResponseListTimesheetTask {
    data?: Array<CsApiTimesheetTask>;
    status?: CsApiApiResponseListTimesheetTask.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseListTimesheetTask {
