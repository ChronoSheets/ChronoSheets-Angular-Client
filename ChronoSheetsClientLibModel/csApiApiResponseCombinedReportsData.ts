 ...
 */
import { CsApiCombinedReportsData } from './csApiCsApiCombinedReportsData';


export interface CsApiApiResponseCombinedReportsData {
    data?: CsApiCombinedReportsData;
    /**
     * 0 = Succeeded, 1 = FatalException, 2 = GeneralError, 3 = ValidationError, 4 = UnAuthorized, 5 = SessionExpired
     */
    status?: CsApiApiResponseCombinedReportsData.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseCombinedReportsData {
