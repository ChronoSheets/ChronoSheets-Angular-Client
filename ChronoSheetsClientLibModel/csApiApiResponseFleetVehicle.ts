...
export interface CsApiApiResponseFleetVehicle {
    data?: CsApiFleetVehicle;
    /**
     * 0 = Succeeded, 1 = FatalException, 2 = GeneralError, 3 = ValidationError, 4 = UnAuthorized, 5 = SessionExpired, 128 = TestingABC
     */
    status?: CsApiApiResponseFleetVehicle.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseFleetVehicle {
