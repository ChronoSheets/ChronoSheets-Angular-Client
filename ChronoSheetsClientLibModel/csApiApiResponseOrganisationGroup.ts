...
export interface CsApiApiResponseOrganisationGroup {
    data?: CsApiOrganisationGroup;
    /**
     * 0 = Succeeded, 1 = FatalException, 2 = GeneralError, 3 = ValidationError, 4 = UnAuthorized, 5 = SessionExpired
     */
    status?: CsApiApiResponseOrganisationGroup.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseOrganisationGroup {
