...
export interface CSApiResponseForPaginatedListTimesheetFileAttachment {
    totalSetCount?: number;
    data?: Array<CSTimesheetFileAttachment>;
    status?: CSApiResponseForPaginatedListTimesheetFileAttachment.CSStatusEnum;
    message?: string;
}
export namespace CSApiResponseForPaginatedListTimesheetFileAttachment {
