 ...
 */
import { CsApiFleetVehicle } from './csApiCsApiFleetVehicle';


export interface CsApiApiResponseListFleetVehicle {
    data?: Array<CsApiFleetVehicle>;
    /**
     * 0 = Succeeded, 1 = FatalException, 2 = GeneralError, 3 = ValidationError, 4 = UnAuthorized, 5 = SessionExpired, 128 = TestingABC
     */
    status?: CsApiApiResponseListFleetVehicle.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseListFleetVehicle {
