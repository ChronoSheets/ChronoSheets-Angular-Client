 ...
 */
import { CSTimesheetAutomationWithOrgAndGeofence } from './cSCSTimesheetAutomationWithOrgAndGeofence';


/**
 * A paginated API repsonse
 */
export interface CSApiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence { 
    /**
     ...
     */
    data?: Array<CSTimesheetAutomationWithOrgAndGeofence>;
    /**
     * The API response status. Indicates if the request was successful, failed or was unauthorised.
     */
    status?: CSApiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence.CSStatusEnum;
    /**
...
export namespace CSApiResponseForPaginatedListTimesheetAutomationWithOrgAndGeofence {
