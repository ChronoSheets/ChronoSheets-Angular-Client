...
export interface CSApiResponseListUserForManagement {
    data?: Array<CSUserForManagement>;
    status?: CSApiResponseListUserForManagement.CSStatusEnum;
    message?: string;
}
export namespace CSApiResponseListUserForManagement {
