...
export interface CsApiApiResponseOrganisation {
    data?: CsApiOrganisation;
    status?: CsApiApiResponseOrganisation.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseOrganisation {
