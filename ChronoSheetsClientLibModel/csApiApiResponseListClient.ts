 ...
 */
import { CsApiClient } from './csApiCsApiClient';


export interface CsApiApiResponseListClient {
    data?: Array<CsApiClient>;
    /**
     * 0 = Succeeded, 1 = FatalException, 2 = GeneralError, 3 = ValidationError, 4 = UnAuthorized, 5 = SessionExpired
     */
    status?: CsApiApiResponseListClient.CsApiStatusEnum;
    message?: string;
}
export namespace CsApiApiResponseListClient {
