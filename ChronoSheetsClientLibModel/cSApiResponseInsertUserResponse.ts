 ...
 */
import { CSInsertUserResponse } from './cSCSInsertUserResponse';


export interface CSApiResponseInsertUserResponse { 
    data?: CSInsertUserResponse;
    status?: CSApiResponseInsertUserResponse.CSStatusEnum;
    message?: string;
}
export namespace CSApiResponseInsertUserResponse {
